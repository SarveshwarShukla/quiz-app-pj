...
class Main extends JFrame implements ActionListener {
    ...
    void set() {
        ...
        if (current == 0) {
            l.setText("Question 1");
            jb[0].setText("Option A");
            jb[1].setText("Option B");
            jb[2].setText("Option C");
            jb[3].setText("Option D");
        }
        if (current == 1) {
            l.setText("Question 2");
            jb[0].setText("Option A");
            jb[1].setText("Option B");
            jb[2].setText("Option C");
            jb[3].setText("Option D");
        ...
        l.setBounds(30, 40, 450, 20);
        for (int i = 0, j = 0; i <= 90; i += 30, j++) jb[j].setBounds(
                50,
                80 + i,
                200,
                20
    ...
    public static void main(String[] s) {
        new Main("Online Quiz by Premraj");
    }
}